...
class Brands {
  Map<String, IconData> getBrandLogoMap() {
    return {
      "Nike": SimpleIcons.nike,
      "Adidas": SimpleIcons.adidas,
      "Puma": SimpleIcons.puma,
      "Under Armour": SimpleIcons.underarmour,
      "Reebok": SimpleIcons.reebok,
      "New Balance": SimpleIcons.newbalance,
      "McDonald\"s": SimpleIcons.mcdonalds,
      "Burger King": SimpleIcons.burgerking,
      "KFC": SimpleIcons.kfc,
